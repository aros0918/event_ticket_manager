...
@section('title') @lang('em.home') @endsection
        ...
        <div class="row">
            <div class="col-12">
                <div class="card border-0 p-2 search-form rounded-md-pill smooth-shadow-md mt-n5">
                    <form type="GET" action="{{ route('events_index') }}">
                            ...
                            <div class="col-sm">
                                <div class="form-floating">
                                    <select
                                        ...
                                        id="city" name="city">
                                        <option value="All">@lang('em.all')</option>
                                        @foreach ($cities as $val)
                                            <option value="{{ $val['city'] }}">{{ $val['city'] }}, {{ $val['state'] }}
                                            </option>
                                        @endforeach
                                    </select>
                                    <label for="city_select">{{ __('em.city') }}</label>
                                </div>
                            </div>
                            <div class="col-sm">
                                <div class="form-floating">
                                    ...
                                    <label for="category">{{ __('em.category') }}</label>
                                </div>
                            </div>
                            <div class="col-sm-1">
                                ...
                                <div class="d-md-flex justify-content-end ms-md-n3 ms-lg-0  d-block d-md-none">
                                    <button type="submit"
                                        class="btn btn-primary d-grid gap-2 col-12 mx-auto">@lang('em.search')</button>
                                </div>
                            </div>
                        </div>
                    </form>
    ...
    @if (!empty($categories))
        <div class="py-5 bg-gradient">
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <h3 class="text-white">@lang('em.event_categories')</h3>
                    </div>
                </div>
                <div class="row">
                    @php $i = 0; @endphp
                    @foreach ($categories as $key => $item)
                        ...
                        <div class="d-flex align-items-lg-stretch col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12' }}">
                            <div class="card w-100 border-0 overlay-bg img-hover mb-3"
                                @php 
                                    $thumbPath = str_replace(['\\', ' '], ['/', '%20'], $item['thumb']);
        $bgimg = asset('/storage/' . $thumbPath); 
                                @endphp
                                ...
                                <a class="stretched-link"
                                    href="{{ route('events_index', ['category' => urlencode($item['name'])]) }}"></a>
                            </div>
                        </div>
                    @endforeach
                </div>
            ...
            <div class="row ">
                <div class="col-12">
                    <div class="text-center mb-10">
                        <p class="mb-0">@lang('em.how_it_works') </p>
                        <h2 class="mb-1">@lang('em.for_customers')</h2>
                    </div>
                </div>
            </div>
            <div class="row ">
                <div class="col-md-4 col-12">
                    <div class="step text-center mb-6 mb-lg-0">
                        ...
                        <h3 class="mb-3">1. @lang('em.customer_1')</h3>
                        <p class="mb-0 px-lg-3">@lang('em.customer_1_info') </p>
                    </div>
                ...
                <div class="col-md-4 col-12">
                    <div class="step text-center mb-6 mb-lg-0">
                        ...
                        <h3 class="mb-3">2. @lang('em.customer_2')</h3>
                        <p class="mb-0 px-lg-3">@lang('em.customer_2_info')</p>
                    </div>
                </div>
                <div class="col-md-4 col-12">
                    <div class="text-center mb-6 mb-lg-0">
                        ...
                        <h3 class="mb-3">3. @lang('em.customer_3')</h3>
                        <p class="mb-0 px-lg-3">@lang('em.customer_3_info') </p>
                    </div>
                </div>
            </div>
        </div>
...
<script type="text/javascript" src="{{ static_asset('js/welcome.js') }}"></script>
@stop
