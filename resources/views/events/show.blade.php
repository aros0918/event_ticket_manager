                ...
                <div class="row">
                    <div class="col-xl-8 col-lg-8 col-md-12 col-12">
                        <div class="card mb-4">
                            ...
                            <div class="card-body p-4 py-3">
                                ...
                                <p class="fs-6 mb-2">
                                    ...
                                    <span class="badge bg-primary text-white">@lang('em.free_tickets')</span>

                                    @if ($ended)
                                    <span class="badge bg-danger text-white">@lang('em.event_ended')</span>
                                    @endif
                                </p>
                            </div>
                            <div class="card-footer bg-gradient">
                                <div class="text-white">
                                    <span><strong>@lang('em.share_event') &nbsp;</strong></span>
                        ...
                        <div class="card mb-4 bg-light" id="buy-tickets">
                            <div class="card-body p-4">
                                <div class="mb-4 text-left">
                                    <h4 class="mb-0 fw-bold h4">@lang('em.get_tickets')</h4>
                                </div>
                                <div class="row">
                        ...
                        @if ($event['faq'])
                            <div class="card mb-4">
                                <div class="card-body p-4">
                                    <h4 class=" text-left">@lang('em.event_info')</h4>
                                    <p>{!! $event['faq'] !!}</p>
                                </div>
                            </div>
                        @endif
                        ...
                        @if (!empty($event->images))
                            <div class="card mb-4">
                                <div class="card-body p-4 pb-0">
                                    <h4 class="mb-3">@lang('em.event_gallery')</h4>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 col-12">
                        ...
                        <div class="card mb-4">
                            <div class="card-body p-4">
                                <div class="container">
                                    ...
                                    @endphp
                                    <ticket-calendar 
                                        :start-time="{{ json_encode(date('H:i', strtotime($event->start_time))) }}" 
                                        :end-time="{{ json_encode(date('H:i', strtotime($event->end_time))) }}" 
                                        :interval-time="{{ $event->interval_time }}"
                                        :disable-date="{{ $event->disable_date }}"
                        ...
                        <div class="card mb-4">
                            <div class="card-body">
                                <!-- card-->
                                <h4 class="mb-2 fw-bold">@lang('em.where')</h4>
                                <p>
                        ...
                        <div class="card  mb-4">
                            <div class="card-body">
                                <h4 class="mb-2 fw-bold">@lang('em.when')</h4>
                                    <p>
...
@section('javascript')
    <script type="text/javascript" src="{{ static_asset('js/events_show.js') }}"></script>
@stop
