...
@section('page_header')
    <div class="container-fluid">
        ...
        <a href="{{ route('myevents_form')}}" class="btn btn-success btn-add-new">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                            ...
                                            <a href="{{ route('myevents_form',[$data->slug])}}" class="btn btn-sm btn-primary edit pull-right">
                                                <i class="voyager-edit"></i> <span class="hidden-xs hidden-sm">{{ __('voyager::generic.edit') }}</span>
                                            </a>

                                            @if($data->publish > 0)
                                            <a href="{{ route('events_show', [$data->slug]) }}" class="btn btn-sm btn-warning pull-right">
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        ...
                                                        <div class="modal-footer">
                                                            <form action="{{ route('delete_event',[$data->slug]) }}" id="delete_form" method="GET">
                                                                {{ csrf_field() }}
