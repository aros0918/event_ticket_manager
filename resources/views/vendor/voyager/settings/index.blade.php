                ...
                <div class="page-content settings container-fluid">
                    ...
                    <div class="tab-content">
                        ...
                        <div id="{{ \Illuminate\Support\Str::slug($group) }}" class="tab-pane fade in @if($group == $active) active @endif">
                            ...
                            <br>
                            <div class="alert alert-info">
                                {{ __('voyager::generic.Set Callback URL on your Google App Dashboard') }} - <code>{{ route('oauth_callback', ['social' => 'google']) }}</code>
                            </div>
                            @endif
                            ...
                            <br>
                            <div class="alert alert-info">
                                {{ __('voyager::generic.Set Callback URL on your Facebook App Dashboard') }} - <code>{{ route('oauth_callback', ['social' => 'facebook']) }}</code>
                            </div>
                            @endif
                            ...
                            <br>
                            <div class="alert alert-info">
                                {{ __('voyager::generic.Set Callback URL on your PayPal Dashboard') }} - <code>{{ route('bookings_paypal_callback') }}</code>
                            </div>
                            @endif
