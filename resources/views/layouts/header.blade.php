<div id="navbar_vue"
    ...
    <div class="{{ \Str::contains(url()->current(), 'dashboard') ? 'dashboard-container' : 'container' }}">
        <div class="row">
            <div class="col-md-12">
                <!-- GDPR -->
                <cookie-law theme="gdpr" button-text="@lang('em.accept')">
                    <div slot="message">
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                            ...
                            @if (!empty($categoriesMenu))
                                ...
                                <li class="nav-item dropdown ">
                                    <a class="nav-link dropdown-toggle" href="#" id="homeDropdown" role="button"
                                        ...
                                        @lang('em.categories')&nbsp;<i class="fas fa-caret-down"></i>
                                    </a>
                                    <ul class="dropdown-menu">
                                        @foreach ($categoriesMenu as $val)
                                            <li>
                                                <a class="dropdown-item"
                                                    href="{{ route('events_index', ['category' => urlencode($val->name)]) }}">
                                                    {{ $val->name }}
                                                </a>
                        ...
                        <a class="btn btn-success d-none d-lg-block me-2" target="_blank" href="https://github.com/dybbuk-dev"><i class="fab fa-github col-black"></i></a>
                        @endif

                        <a href="{{ route('events_index') }}"
                            class="btn btn-primary d-none d-lg-block bg-gradient">
                            <i class="fas fa-calendar-day"></i> @lang('em.browse_events')
                        </a>
                    </div>
                </nav>
            </div>
