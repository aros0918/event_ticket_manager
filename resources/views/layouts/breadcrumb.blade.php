                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item ">
                            <a href="{{ route('welcome') }}"><i class="fas fa-home text-white"></i></a>
                        </li>
                        @php
$i_count = 1;
if (config('custom.route.prefix')) {
    $i_count = 2;
    $prefix_count = count(explode('/', config('custom.route.prefix')));
    if ($prefix_count > 1) {
                            ...
                            @if ($i != count(Request::segments()))
                                <li class="breadcrumb-item">
                                    <a
                                        ...
                                        @if (\Lang::has('em.' . strtolower(Request::segment($i))))
                                            @lang('em.' . strtolower(Request::segment($i)))
                                        @else
