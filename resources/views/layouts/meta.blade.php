...
<!-- Base URL -->
<meta name="base-url" content="{{ static_url() }}"/>
...
<!-- SITE TITLE -->
<title>{{ setting('site.site_name') ? setting('site.site_name') : config('app.name') }} - @yield('title', __('em.home'))</title>

<!-- Facebook Meta -->
<meta property="og:url"           content="@yield('meta_url', static_url())" />
...
<meta name="url" content="@yield('meta_url', static_url())" >
