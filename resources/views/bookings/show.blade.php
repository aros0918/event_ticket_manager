                        ...
                        <div class="card border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <h3 class="text-center bg-light p-3">@lang('em.booking_info')</h3>
                                    <table class="table">
                                        <tr>
                                            <th>@lang('em.order_id')</th>
                                            <td>{{ $booking['order_number'] }}</td>
                                        </tr>

                                        <tr>
                                            <th>@lang('em.event_category')</th>
                                        ...
                                        <tr>
                                            <th>@lang('em.end_date')</th>
                                            @if (
    userTimezone($booking['event_start_date'] . ' ' . $booking['event_start_time'], 'Y-m-d H:i:s', 'Y-m-d') <=
                    ...
                    <div class="col-xl-6 col-lg-6 col-12">
                        ...
                        <div class="card mb-4 border-0 shadow-sm">
                            ...
                            <div class="card-body">
                                ...
                                <h3 class="text-center bg-light p-3">@lang('em.customer_info')</h3>
                                <hr>
