        ...
        >
            ...
            <div class="mb-3">
                ...
                <input
                    ...
                    @change="isDirty()"
                />
                <span v-show="errors.has('title')" class="help text-danger">{{
                    errors.first("title")
                }}</span>
            </div>
            ...
            <div class="mb-3">
                ...
                />
                <p>
                    <a target="_blank" :href="slugUrl()">{{ slugUrl() }}</a>
                </p>
            </div>
            ...
            <div class="mb-3">
                ...
                <span v-show="errors.has('faq')" class="help text-danger">{{
                    errors.first("faq")
                }}</span>
            </div>
...
export default {
    ...
    methods: {
        ...
        formSubmit(event) {
            ...
            let post_url = route("myevents_store");
                ...
                .then((res) => {
                    ...
                    if (res.data.status) {
                        ...
                        if (res.data.slug) {
                            ...
                            setTimeout(function () {
                                window.location = route("myevents_form", [
                                    res.data.slug,
                                ]);
                            }, 1000);
                        }
        ...
        getCategories() {
            let post_url = route("myevents_categories");
        ...
        slugUrl() {
            if (this.slug != null)
                return route("events_index") + "/" + this.slug;
