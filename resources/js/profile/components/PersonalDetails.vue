                    ...
                    <div class="panel-heading px-5">
                        ...
                        >
                            ...
                            <div class="form-group row mt-3 mt-5">
                                <label class="form-label col-md-3 form-label">{{
                                    this.is_organiser == true
                                        ? trans("em.organisation_logo")
                                        : trans("em.avatar")
                                }}</label>
                                <div class="col-md-9">
                                    <input
