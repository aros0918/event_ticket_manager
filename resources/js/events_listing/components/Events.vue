                ...
                <div class="col-md-3">
                    <div class="form-group mb-3">
                        ...
                        <date-picker
                            ...
                            :placeholder="trans('em.date_filter')"
                            format="YYYY-MM-DD"
                        ></date-picker>
                    </div>
                </div>
