                        ...
                        <table class="table text-wrap table-hover">
                            ...
                            <tbody>
                                ...
                                >
                                        ...
                                        <div class="d-flex align-items-center">
                                            ...
                                            >
                                                <img
                                                    :src="
                                                        '/storage/' +
                                                        booking.event_thumbnail
                                                    "
                                                    :alt="booking.event_title"
                                                    class="rounded img-4by3-md"
                                                />
                                            </a>
                                            <div class="ms-3 lh-1">
                                                <h5 class="mb-1">
                                    ...
                                    <td
                                        class="align-middle"
                                        :data-title="trans('em.order_total')"
                                    >
                                        {{ booking.price }}
                                    </td>
                                    <td
                                        class="align-middle"
                                        :data-title="trans('em.booked_on')"
                                    >
                                        {{
                                            moment(
                                                userTimezone(
                                    ...
                                    >
                                        <span
                                            ...
                                            v-if="
                                                ...
                                                booking.expired == 0
                                            "
                                            >{{ trans("em.active") }}</span
                                        >
                                        <span
                                            class="badge bg-danger text-white"
                                            v-else
                                            >{{ trans("em.inactive") }}</span
                                        >
                                    </td>
                                </tr>
...
export default {
    ...
    methods: {
        ...
        getMyBookings() {
            axios
                .get(route("mybookings") + "?page=" + this.current_page)
                .then((res) => {
