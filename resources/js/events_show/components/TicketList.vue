<template>
    <div>
        ...
        <div class="d-grid">
            ...
            >
                <i class="fas fa-ticket-alt"></i> {{ trans("em.get_tickets") }}
            </button>
        </div>
                        ...
                        <div class="modal-header text-center border-0">
                            <div class="modal-title w-100">
                                <div>
                                    ...
                                    <ul
                                        class="list-group list-group-horizontal list-group-flush justify-content-center"
                                    >
                                        <li
                                            class="list-group-item text-sm border-0 px-0 pe-sm-3"
                                        >
                                            <small
                                                ><i
                                                    class="fas fa-location-dot text-primary"
                                                ></i>
                                                {{ event.venue }}</small
                                            >
                                            &nbsp;
                                ...
                                <div class="px-lg-3">
                                    ...
                                    <div class="row">
                                        <div class="col-12">
                                            ...
                                            <ul class="list-group">
                                                <li
                                                    class="list-group-item mb-3 rounded border-2"
                                                >
                                                    <div
                                    ...
                                    <div class="row" v-if="quantity > 0">
                                        ...
                                        <div class="col-12 mt-2 pb-4">
                                            <div class="d-grid">
                                                <div
                                                    class="btn-group btn-group-md btn-block btn-group-justified"
                                                >
                                                    <button
                                                        :class="{
                                                            disabled: disable,
...
export default {
    ...
    props: ["max_ticket_qty", "event", "customer", "is_customer", "is_admin"],
    ...
    methods: {
        ...
        bookTickets() {
            ...
            let post_url = route("bookings_book_tickets");
        ...
        getCustomers(loading, search = null) {
            var postUrl = route("get_customers");
            var _this = this;
            axios
                .post(postUrl, {
                    search: search,
        ...
        scrollToBottom() {
            this.$refs["bottom-down"].scrollIntoView({
                block: "end",
                inline: "nearest",
            });
        },
