...
class ProfileController extends Controller
{
     ...
     * @return view
     */
    public function index($view = 'profile.profile', $extra = [])
    {
        $user = $this->getAuthUser();

        return view($view, compact('user', 'extra'));
    }
    ...
    public function updateAuthUser(Request $request)
    {
        ...
        $msg = __('em.saved') . ' ' . __('em.successfully');
        return success_redirect($msg, route('profile'));
    ...
    public function updateSecurity(Request $request)
    {
        ...
        // redirect no matter what so that it never turns back
        $msg = __('em.saved') . ' ' . __('em.successfully');
        return success_redirect($msg, route('profile') . '#/userSecurity');
    }
    ...
    public function updateAuthUserPassword(Request $request)
    {
        ...
        if (!Hash::check($request->current, $user->password)) {
            return ['errors' => __('em.current_password_not_match'), 'status' => false];
        }
