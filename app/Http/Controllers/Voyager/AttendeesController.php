...
class AttendeesController extends VoyagerBaseController
{
    ...
    public function __construct()
    {
        ...
        if (!in_array(\Route::current()->getName(), $enable_routes)) {
            return redirect()->route('voyager.attendees.index')->send();
        }
        // ---------------------------------------------------------------------
    }
    ...
    public function index(Request $request)
    {
        ...
        $view = 'vendor.voyager.attendees.browse';
