 ...
 * Asset helpers
 * 
 * Make a direct access link to asset route 
 * 
 */
if (!function_exists('static_asset')) {
    function static_asset($path, $secure = null)
    {
        return route('assets') . '?path=' . urlencode($path);
    }
}
...
if (!function_exists('static_url')) {
    ...
    {
        return url(config('custom.route.prefix') . '/' . $url);
    }
}
...
if (!function_exists('is_rtl')) {
    ...
    function is_rtl()
    {
        $rtl_langs = config('custom.rtl_langs');
