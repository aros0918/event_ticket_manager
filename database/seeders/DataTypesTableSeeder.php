        ...
        if (!$dataType->exists) {
            ...
            \DB::table('data_types')->insert(
                array(
                    ...
                    'policy_name' => NULL,
                    'controller' => '\\App\\Http\\Controllers\\Voyager\\EventsController',
                    'description' => NULL,
                    'generate_permissions' => 1,
                    'server_side' => 1,
            ...
            \DB::table('data_types')->insert(
                array(
                    ...
                    'policy_name' => NULL,
                    'controller' => '\\App\\Http\\Controllers\\Voyager\\ContactsController',
                    'description' => NULL,
                    'generate_permissions' => 1,
                    'server_side' => 1,
            ...
            \DB::table('data_types')->insert(
                array(
                    ...
                    'name' => 'bookings',
                    'slug' => 'bookings',
                    'display_name_singular' => 'Validate',
                    'display_name_plural' => 'Validate',
                    'icon' => 'voyager-dollar',
                    'model_name' => 'App\\Models\\Booking',
                    'policy_name' => NULL,
                    'controller' => '\\App\\Http\\Controllers\\Voyager\\BookingsController',
                    'description' => NULL,
                    'generate_permissions' => 1,
                    'server_side' => 1,
                    'details' => '{"order_column":null,"order_display_column":null,"order_direction":"asc","default_search_key":null,"scope":null}',
